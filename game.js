...
const CLANS={
  exorcist:{name:"Exorcist Clan",emoji:"🌿",color:"#4ade80",lore:"Masters of purification and holy strikes.",
    versions:{
      1:{name:"Initiate",buff:"+1 dmg on first shot per round"},
      2:{name:"Acolyte",buff:"+2 dmg on first shot per round"},
      3:{name:"Exorcist",buff:"+2 dmg + lifesteal 1 HP on first shot"},
      4:{name:"Grand Exorcist",buff:"HOLY FLAME: First shot ignores enemy shield entirely",special:true},
    }},
  eclipse:{name:"Eclipse Clan",emoji:"🌑",color:"#a855f7",lore:"Shadow walkers who manipulate fate and darkness.",
    versions:{
      1:{name:"Shade",buff:"10% chance to dodge 1 damage"},
      2:{name:"Dusk Blade",buff:"20% chance to dodge 1 damage"},
      3:{name:"Nightfall",buff:"25% dodge + enemy sees wrong shield hint"},
      4:{name:"Total Eclipse",buff:"VOID WALK: 35% dodge + first shot always crits",special:true},
    }},
  hydros:{name:"Hydros Clan",emoji:"💧",color:"#22d3ee",lore:"Fluid warriors who flow like water around every strike.",
    versions:{
      ...
      3:{name:"Stormtide",buff:"Potions heal +5 HP + recover 1 shield point"},
      4:{name:"Abyssal Tide",buff:"DEEP SURGE: Potions heal +8 HP + deal 3 dmg to enemy",special:true},
    }},
  vulcryn:{name:"Vulcryn Clan",emoji:"🔥",color:"#ff6b35",lore:"Forge-born warriors who burn hotter the longer they fight.",
    versions:{
      1:{name:"Ember",buff:"Deal +1 dmg when HP < 15"},
      2:{name:"Inferno",buff:"Deal +2 dmg when HP < 15"},
      3:{name:"Pyroclast",buff:"+2 dmg below 15 HP + 5% lifesteal"},
      4:{name:"Molten Core",buff:"ERUPTION: +3 dmg all shots + every 3rd shot burns enemy for -2 HP next turn",special:true},
    }},
};
